    ...
    <div id="content" class="main-content">
        <div class="layout-px-spacing">
            ...
            <div class="page-header">
                ...
                <a class="btn btn-success float-left" href="{{route('create.category')}}">
                    جدید
                </a>
            </div>
                ...
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                   ...
                   {{--                     <td>{{$cat->status}}</td>--}}
                                        <td class="text-center">
                                            <a href="{{route('createsub.category',$cat->id)}}" class="btn btn-success">
                                               افزودن
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{route('index.categorysub',$cat->id)}}"
