        ...
        <div class="layout-px-spacing">
            ...
            <div class="page-header">
                <div class="page-title">
                    <h3  style="font-size: 14px;">بخش زیردسته - (

                        <a class="btn btn-warning btn-sm" href="{{route('index.category')}}">
                           {{$catmain->name}}
                        </a>
                        ...
                        <div class="table-responsive mb-4 mt-4">
                            <table id="default-ordering"
                                ...
                                @foreach($category as $cat)
                                    ...
                                    <tr>
                                        <td><img width="50" src="{{$cat->images['thumb']}}"></td>
                                        <td>{{$cat->name}}</td>
                                        <td>{{$cat->hit}}</td>
                                       {{-- <td>{{$cat->status}}</td>--}}
                                        <td class="text-center">
                                            <a href="{{route('createsub2.category',[$cat->idcat1,$cat->id])}}" class="btn btn-success">
                                                افزودن</a>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{route('index.categorysub2',$cat->id)}}"
                                        ...
                                        <td class="text-center">
                                            <a href="{{route('edit.categoryto',$cat->id)}}"
