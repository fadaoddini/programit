    ...
    <div id="content" class="main-content">
        <div class="layout-px-spacing">
            ...
            <div class="page-header">
                ...
                <a class="btn btn-success float-left" href="{{route('create.epizod')}}">
                    جدید
                </a>
            </div>
                    ...
                    <div class="widget-content widget-content-area br-6">
                        <div class="table-responsive mb-4 mt-4">
                            <table id="default-ordering"
                                ...
                                @foreach($epizods as $epizod)
                                    <tr>

                                        <td>{{$epizod->name}}</td>
                                        <td>{{$epizod->course_id}}</td>
                                        <td>{{$epizod->time}}</td>
                                        <td>{{$epizod->number}}</td>

                                        <td><a class="btn-sm btn btn-success"  href=" {{$epizod->videoUrl}}">نمایش </a></td>

                                        <td><a class="btn-sm btn btn-warning"  href=" {{$epizod->images}}">محتوا </a></td>
                                        <td>{{$epizod->downloadCount}}</td>



                                        <td class="text-center">
                                            <a href="{{route('edit.epizod',$epizod->id)}}"
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path
            ...
            fill="#000000" fill-rule="nonzero" opacity="0.3"></path>
                                            ...
                                            <a href="{{route('epizod.destroy',$epizod->id)}}"
                                               onclick="return confirm('آیا رسانه حذف شود؟');"
